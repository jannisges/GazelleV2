...
class PatchManager {
    constructor() {
        ...
        // 2D Plan View properties
        this.planView = null;
        this.planViewContent = null;
        this.zoom = 1;
        this.panX = 0;
        this.panY = 0;
        this.gridSize = 50; // Grid size in pixels
    ...
    startDragFixture(e, patch) {
        ...
        // Calculate offset from mouse to fixture center
        const fixtureRect = fixture.getBoundingClientRect();
        this.dragOffset.x = e.clientX - fixtureRect.left - 15; // 15 is half fixture width
        this.dragOffset.y = e.clientY - fixtureRect.top - 15;  // 15 is half fixture height
